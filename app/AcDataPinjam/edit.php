...
$sql = "SELECT * FROM $namatbl WHERE id_pinjam=$id";
                ...
                <form class="form-horizontal" action="./edit2-proses.php" method="POST">
                    ...
                    <div class="row p-2">
                      ...
                      <div class="col-md-5 text-center" id="elemNameParent">
                        <input type="text" placeholder="Masukkan ID Motor yang dipinjam" name="idmotor" value="<?php echo $data['id_motor'] ?>">
                      </div>
                    </div>
                    <div class="row p-2">
                      ...
                      <div class="col-md-5 text-center" id="elemAgeParent">
                        <input type="text" placeholder="Masukkan ID User peminjam" name="iduserpeminjam" value="<?php echo $data['id_user_peminjam'] ?>">
                      </div>
                    </div>
                    <div class="row p-2">
